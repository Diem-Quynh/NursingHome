...
module.exports = __webpack_require__("nwJv");
...
// CONCATENATED MODULE: ./themes/layouts/Login.jsx
...
class Login_Login extends external_react_default.a.Component {
  render() {
    return __jsx(external_antd_["Layout"], null, __jsx(head_default.a, null, __jsx("title", null, this.props.title || "")), __jsx("div", {
      id: "login"
    }, __jsx(Content, {
      className: "content"
    }, this.props.children)));
...
/* harmony default export */ var layouts_Login = (Login_Login);
...
// CONCATENATED MODULE: ./pages/admin/login/index.tsx
...
const login_Login = () => {
  ...
  const onFinish = async values => {
    setLoading(true);
    let [error, result] = await external_await_to_js_default()(userService.login({
      data: values
    }));
    setLoading(false);
  ...
  return login_jsx(layouts_Login, null, login_jsx("div", {
    className: "logo"
  }, login_jsx("div", {
    className: "img"
  }, login_jsx("img", {
    ...
    className: "sitename"
  }, t('admincp'))), login_jsx(external_antd_["Form"], {
    onFinish: onFinish,
    form: form,
    name: "loginForm",
    layout: "horizontal",
  ...
  }, login_jsx(external_antd_["Form"].Item, {
    name: "username",
    rules: [{
      required: true,
      message: t('form.required')
    }]
  }, login_jsx(external_antd_["Input"], {
    placeholder: t('username'),
    prefix: login_jsx(icons_["UserOutlined"], {
      style: {
        color: 'rgba(0,0,0,.25)'
      }
    })
  ...
  }, login_jsx(external_antd_["Input"].Password, {
    placeholder: t('password'),
    prefix: login_jsx(icons_["LockOutlined"], {
      style: {
        color: 'rgba(0,0,0,.25)'
      }
    })
  })), login_jsx(external_antd_["Form"].Item, null, login_jsx(external_antd_["Button"], {
    className: "btnLogin",
    type: "primary",
    htmlType: "submit",
    loading: loading
